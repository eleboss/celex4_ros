...
FPGADataProcessor::FPGADataProcessor()
	: m_bIsGeneratingFPN(false), m_bAdjustBrightness(false), m_iFpnCalculationTimes(0), m_uiFullPicPixelCount(0), m_uiOpticalFlowPixelCount(0), m_uiEventPixelCount(0), m_uiUpperADC(511), m_uiLowerADC(0), m_uiTimeSlice(750000), m_uiTimeSliceValue(60), m_uiClockRate(25), m_uiFPGATimeCycle(131072), m_uiFrameStartT(0), m_uiFrameEndT(0), m_uiFEEventTCounter(0), m_uiFEFrameTime(0), m_uiOverlapTime(0), m_uiMeanIntensity(0), m_ulOverlapEventTCounter(0), m_ulSpecialEventCount(0), m_ulSpecialByteSize(0), m_emSensorMode(EventMode), m_pEventPicBuffer(NULL), m_pLastEventPicBuffer(NULL), m_bMultiSliceEnabled(false), m_bNeedResetMultiSliceData(true), m_uiMultiSliceTime(1250000), m_uiMultiSliceCount(255), m_ulEventTCounter(0), m_ulMultiSliceTCounter(0), m_ulEventCountTotal(0), m_uiTimeStamp(750000), m_uiTimeScale(1)
{
	isCreateImage = false;
	isReadBin = false;
...
void FPGADataProcessor::processData(unsigned char *data, long length, bool special)
{
	if (!data)
	{
		return;
